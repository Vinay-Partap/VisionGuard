# detector/speed_estimator.py  (deploy branch — new file)
import time
import numpy as np
...
class SpeedEstimator:
    ...
    pixels_per_meter: calibration — how many px = 1 real metre.
    """
    def __init__(self, pixels_per_meter=40.0):
        self.ppm      = pixels_per_meter
        self._history = defaultdict(lambda: deque(maxlen=15))
        self._speeds  = {}
    ...
    def update(self, oid, cx, cy):
        ...
        self._speeds[oid] = min(round((px_dist / self.ppm / dt) * 3.6, 1), 200.0)
