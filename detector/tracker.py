# detector/tracker.py  (deploy branch — was empty, now implemented)
import numpy as np
...
class CentroidTracker:
    def __init__(self, max_disappeared=30, max_distance=80):
        self.next_id     = 0
        self.objects     = OrderedDict()   # id → centroid array
        self.labels      = OrderedDict()   # id → label string
    ...
    def update(self, rects, labels):
        ...
        labels : list of label strings, same order
